...
getSettingsString :
    ...
    -> Effect msg
getSettingsString options =
    Api.tryString
        options.onResponse
        (Api.Operations.getSettingsString
            options.baseUrl
            options.session
            options
        )
